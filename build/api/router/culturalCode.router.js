...
const culturalCode_controller_1 = __importDefault(require("../controller/culturalCode.controller"));
...
class CulturalCodeRouter {
    main() {
        ...
        router.post("/culturalCode/upload", (req, res, next) => {
            uploadFIlesMiddleware.main(req, res, next, (size, filename) => {
                // console.log(filename + " - " + bytesToMegas(size)+"MB");
            });
        }, (req, res) => {
